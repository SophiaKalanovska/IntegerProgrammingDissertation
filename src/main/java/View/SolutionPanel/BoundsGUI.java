...
public class BoundsGUI extends JPanel{
    ...
    public BoundsGUI(LowerBoundClusterGUI lowerBoundClusterGUI, UpperBoundClusterGUI upperBoundClusterGUI){
        ...
        Border topBorder3 = BorderFactory.createMatteBorder(1, 1, 1, 1, new Color(153, 218, 250));
        ...
        Border topBorder5 = BorderFactory.createMatteBorder(1, 0, 1, 1, new Color(153, 218, 250));
